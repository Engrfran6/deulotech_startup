function AppEstimateStep() {
  ...
  const [allAnsIds, setAllAnsIds] = React.useState("");
  const [hoursPriceData, setHoursPriceData] = React.useState({});
  const [userName, setUserName] = React.useState("");
  const [phone, setPhone] = React.useState("");
  const [emailValue, setEmailValue] = React.useState("");
  const [isWhatsapp, setIsWhatsapp] = React.useState(true);
  const [projectDescription, setProjectDescription] = React.useState("");
  const [freeBA, setFreeBA] = React.useState(true);
  ...
  const [countryList, setCounrtyList] = React.useState([]);
  const [loader, setLoader] = React.useState(false);
  const [loader1, setLoader1] = React.useState(true);
  const [boxHovered, setBoxHover] = React.useState(false);
  const [loaderTurn, setLoaderTurn] = React.useState(0);
  ...
  const budgetArray = ["< $5000", "$5K - $10K", "$10K - $25K", "$25K - $50K", "$50K - $100K", "$100K+"];
  const timelineArray = ["< 1 Month", "1 - 2 Months", "2 - 4 Months", "4 - 8 Months", "8 - 12 Months", "12 Months+"];
  const isBusiness = () => {
    return ["Entrepreneur", "Business owner", "Manager", "Executive", "Designer", "Developer", "Marketer", "Salesperson"].find(ele => ele === profession);
  };
  ...
  const callCountryListApi = () => {
    fetch(allCountriesListApi).then(response => response.json()).then(response => {
      if (response.data) {
  ...
  function renderButton() {
    ...
    }), " Previous")) : null, /*#__PURE__*/React.createElement("div", {
      className: "Next-Div"
    }, /*#__PURE__*/React.createElement("a", {
      className: `form-wizard-next-btn float-right step-${activeStep}`,
      onClick: async () => {
    ...
    }, activeStep !== loaderTurn ? "Loading..." : "Next", " ", /*#__PURE__*/React.createElement("i", {
      className: "icon-Path-13734"
    }))));
  }
  return /*#__PURE__*/React.createElement("section", {
    className: "wizard-section"
  }, activeStep > 9 ? /*#__PURE__*/React.createElement("div", {
    className: "container"
  }, /*#__PURE__*/React.createElement("h5", {
    className: "lastFormTitle"
  }, "Stop. Your search for the right Development Partner ends here..."), /*#__PURE__*/React.createElement("div", {
    ...
    alt: "Union"
  }), /*#__PURE__*/React.createElement("small", null, "Submit the form on your right", "   ", /*#__PURE__*/React.createElement("i", {
    className: "icon-Path-13734"
  })))), /*#__PURE__*/React.createElement("div", {
    className: "OfferText"
  }, /*#__PURE__*/React.createElement("h6", null, "Get ", /*#__PURE__*/React.createElement("strong", null, "one-week"), " project discovery sessions with our experts at ", /*#__PURE__*/React.createElement("strong", null, "zero"), " ", "cost.")))), /*#__PURE__*/React.createElement("div", {
    className: "col-md-6 col-sm-6 col-xs-12"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, `${hoursPriceData.labeltype == "hours" ? "Hours" : "Months"} of development`), /*#__PURE__*/React.createElement("p", {
    style: viewPrice ? {} : {
      filter: "blur(4px)"
    }
  }, viewPrice ? hoursPriceData.hours : "00:00", " ", /*#__PURE__*/React.createElement("small", null, hoursPriceData.labeltype || "")))), /*#__PURE__*/React.createElement("div", {
    className: "HoureDiv"
  }, /*#__PURE__*/React.createElement("div", {
    className: "HoureDivBg"
  }, /*#__PURE__*/React.createElement("i", {
    ...
    className: "outlinedWizad"
  }, /*#__PURE__*/React.createElement("span", null, "Cost of building your app"), /*#__PURE__*/React.createElement("p", {
    style: viewPrice ? {} : {
      filter: "blur(4px)"
    }
  }, viewPrice ? hoursPriceData.price : "0.00", " ", /*#__PURE__*/React.createElement("small", null, "$"))))), /*#__PURE__*/React.createElement("div", {
    className: "WizadLetsForm"
  }, /*#__PURE__*/React.createElement("h5", null, "Let's Get Started"), /*#__PURE__*/React.createElement("small", null, "Get a full estimate"), /*#__PURE__*/React.createElement("div", {
    className: "GetLink"
  }, /*#__PURE__*/React.createElement("span", null, "Detailed feature list,"), " ", /*#__PURE__*/React.createElement("span", null, "Technical architecture,"), " ", /*#__PURE__*/React.createElement("span", null, "and"), " ", /*#__PURE__*/React.createElement("span", null, "Delivery roadmap"))), /*#__PURE__*/React.createElement("div", {
    ...
    for: "isWhatsapp"
  }, "This is my whatsapp number")))), /*#__PURE__*/React.createElement("div", {
    className: "row"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    class: "input-note"
  }, "Please enter your work email if you have. Example: you@company.com")))), /*#__PURE__*/React.createElement("div", {
    className: "row"
  }, /*#__PURE__*/React.createElement("div", {
    className: "col-md-12 col-xs-12"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    for: "freeBA"
  }, "Count me in for the free consultation call and BA session (worth $999)")), /*#__PURE__*/React.createElement("button", {
    type: "submit",
    className: "btn custom-btn common-btn blue wizadButton",
    disabled: loader ? true : false,
    onClick: sendAppEstimate
  }, loader ? "Loading..." : "get full estimate"))), /*#__PURE__*/React.createElement("div", {
    className: "wizadDownClick"
  }, /*#__PURE__*/React.createElement("div", {
    className: "wizadDownText"
  }, /*#__PURE__*/React.createElement("span", null, "Facing trouble in submitting the form? then simply mail us on", /*#__PURE__*/React.createElement("a", {
    type: "email",
    href: "mailto:hello@groovyweb.co"
  }, " ", "hello@groovyweb.co")))))))))))) : /*#__PURE__*/React.createElement("div", {
    ...
    method: "post",
    role: "form",
    style: activeStep !== loaderTurn ? {
      pointerEvents: "none"
    } : null
  }, /*#__PURE__*/React.createElement("div", {
    className: "form-wizard-header"
  }, activeStep == 19 ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h1", null, "Hey There! \uD83D\uDC4B"), /*#__PURE__*/React.createElement("p", {
    class: "mt-14"
  }, "We're thrilled to help you plan your app development journey. \uD83D\uDE80 Our easy-to-use cost calculator takes into account all the factors that can affect app development costs, so you can get a reliable estimate in minutes.", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), "To get started, please provide us with some details about your project.")) : /*#__PURE__*/React.createElement("ul", {
    className: "list-unstyled form-wizard-steps clearfix"
  }, /*#__PURE__*/React.createElement("li", {
    className: activeStep === 0 || activeStep === 1 ? "active" : activeStep > 1 ? "activated" : ""
  }, /*#__PURE__*/React.createElement("p", null, activeStep === 0 ? 'Industry' : 'Platforms'), /*#__PURE__*/React.createElement("span", null, "1")), /*#__PURE__*/React.createElement("li", {
    className: activeStep === 2 ? "active" : activeStep > 2 ? "activated" : ""
  }, /*#__PURE__*/React.createElement("p", null, "Size"), /*#__PURE__*/React.createElement("span", null, "2")), /*#__PURE__*/React.createElement("li", {
    className: activeStep === 3 ? "active" : activeStep > 3 ? "activated" : ""
  }, /*#__PURE__*/React.createElement("p", null, "Users"), /*#__PURE__*/React.createElement("span", null, "3")), /*#__PURE__*/React.createElement("li", {
    className: activeStep === 4 ? "active" : activeStep > 4 ? "activated" : ""
  }, /*#__PURE__*/React.createElement("p", null, "3rd Party"), /*#__PURE__*/React.createElement("span", null, "4")), /*#__PURE__*/React.createElement("li", {
    className: activeStep === 5 ? "active" : activeStep > 5 ? "activated" : ""
  }, /*#__PURE__*/React.createElement("p", null, "UI Design"), /*#__PURE__*/React.createElement("span", null, "5")), /*#__PURE__*/React.createElement("li", {
    className: activeStep === 6 ? "active" : activeStep > 6 ? "activated" : ""
  }, /*#__PURE__*/React.createElement("p", null, "Database"), /*#__PURE__*/React.createElement("span", null, "6")), /*#__PURE__*/React.createElement("li", {
    className: activeStep === 7 ? "active" : activeStep > 7 ? "activated" : ""
  }, /*#__PURE__*/React.createElement("p", null, "Security"), /*#__PURE__*/React.createElement("span", null, "7")), /*#__PURE__*/React.createElement("li", {
    className: activeStep === 8 ? "active" : activeStep > 8 ? "activated" : ""
  }, /*#__PURE__*/React.createElement("p", null, "Features"), /*#__PURE__*/React.createElement("span", null, "8")), /*#__PURE__*/React.createElement("li", {
    className: activeStep === 9 ? "active" : activeStep > 9 ? "activated" : ""
  }, /*#__PURE__*/React.createElement("p", null, "You're"), /*#__PURE__*/React.createElement("span", null, "9")))), activeStep === 0 && /*#__PURE__*/React.createElement("fieldset", {
    className: `wizard-fieldset show ${boxHovered ? "box-hovered" : ""}`
  }, /*#__PURE__*/React.createElement("h5", null, "Select Your Industry"), /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    })), item.tooltip ? /*#__PURE__*/React.createElement("div", {
      class: "CustomToolTip"
    }, /*#__PURE__*/React.createElement("div", {
      class: "toolbg"
    }, /*#__PURE__*/React.createElement("img", {
      ...
      alt: "Info"
    }), /*#__PURE__*/React.createElement("span", null, item.tooltip))) : null);
  })), renderButton()), activeStep === 9 && /*#__PURE__*/React.createElement("div", {
    class: "mainDivWizard"
  }, /*#__PURE__*/React.createElement("fieldset", {
    className: `mt-50 wizard-fieldset show ${boxHovered ? "box-hovered" : ""}`
  }, /*#__PURE__*/React.createElement("div", {
    className: `q-set prof-set ${isBusiness(profession) ? '' : 'hide-sub-q'}`
  }, /*#__PURE__*/React.createElement("h5", {
    class: "question-box"
  }, "1. You're a", /*#__PURE__*/React.createElement("div", {
  ...
  }, " of ", /*#__PURE__*/React.createElement("input", {
    type: "text",
    id: "companyName",
    name: "companyName",
    ...
    class: "answer-box"
  }, professionArray && professionArray.length > 0 && professionArray.map(item => {
    const dData = stepsData[activeStep];
    let bool = false;
    bool = dData && dData.id === item.id && dData.isSelected;
    return /*#__PURE__*/React.createElement("div", {
  ...
  }, "2. You're at Stage of", /*#__PURE__*/React.createElement("div", {
    ...
    class: "answer-box"
  }, projectStages && projectStages.length > 0 && projectStages.map(item => {
    const dData = stepsData[activeStep];
    let bool = false;
    bool = dData && dData.id === item.id && dData.isSelected;
    return /*#__PURE__*/React.createElement("div", {
      ...
      class: "b-icon"
    }, item.emoji), item.title), /*#__PURE__*/React.createElement("input", {
      type: "radio",
      name: "firstcheckbox",
      onClick: () => {
        // handleData(item, "radio");
    ...
    class: "question-box ptop"
  }, "3. Your Budget is  "), /*#__PURE__*/React.createElement("div", {
    ...
    min: "1",
    max: "6",
    labels: "< $5000, $5K - $10K, $10K - $25K, $25K - $50K, $50K - $100K, $100K+",
    ...
    class: "question-box ptop"
  }, "4. Project Timeline "), /*#__PURE__*/React.createElement("div", {
    ...
    min: "1",
    max: "6",
    labels: "< 1 Month, 1 - 2 Months, 2 - 4 Months, 4 - 8 Months, 8 - 12 Months, 12 Months+",
    onChange: e => setTimeline(e.target.value),
    value: timeline
  })))), renderButton())), activeStep >= 1 && questionList && questionList.length > 0 && questionList.map((item, index) => {
    // console.log("item.answers", item);
    if (activeStep === index + 1) {
      return /*#__PURE__*/React.createElement("fieldset", {
        className: `wizard-fieldset show ${boxHovered ? "box-hovered" : ""}`
      }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h5", null, item.title || ""), /*#__PURE__*/React.createElement("div", {
        // className={
        //   activeStep === 2
        //     ? "mainDivWizard"
        //     : "mainDivWizard"
        ...
        let bool = false;
        if (item.type === "radio") {
          bool = item.type === "radio" && dData && dData.id === val.id && dData.isSelected;
        } else if (Array.isArray(dData)) {
          const testData = dData && dData.find(nData => nData.id === val.id);
        ...
        return /*#__PURE__*/React.createElement("div", {
        ...
        }, val.title), /*#__PURE__*/React.createElement("input", {
        ...
        })), val.tooltip ? /*#__PURE__*/React.createElement("div", {
          class: "CustomToolTip"
        }, /*#__PURE__*/React.createElement("div", {
          class: "toolbg"
        }, /*#__PURE__*/React.createElement("img", {
          ...
          src: baseUrl + "/uploads/app_estimate/info.svg",
          alt: "Info"
        }), /*#__PURE__*/React.createElement("span", null, val.tooltip))) : null);
      }))), renderButton());
    }
    return null;
  })))))));
}
ReactDOM.render( /*#__PURE__*/React.createElement(AppEstimateStep, null), document.getElementById("appEstimateStep2"));
