              ...
              <div className="container-fluid container-xl">
                <div className="row">
                  <div className="col-xs-12 col-sm-7 col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">
                      Come to Groovy When you think about Building your Digital Solutions
                    </h1>
                    ...
                    <div className="heroVectorImg technologyvector">
                      <div className="VectorImgborder">
                        <img
                          ...
                          alt="Come to Groovy When you think about Building your Digital Solutions"
                          title="Come to Groovy When you think about Building your Digital Solutions"
                          className="img-fluid"
                        />
                      </div>
                    </div>
                          ...
                          <div className="tab-links-Details whoareBefore">
                            <section id="react" className="active">
                              ...
                              <div className="subTextCategory">
                                <p>
                                  {' '}
                                  <span>I</span>n December 2015, Groovy Web emerged as a fully grown
                                  IT services firm under the encouraging leadership of our founders
                                  who paved the Way to Excellence and Progress for their team
                                  members to follow.{' '}
                                </p>
                                <p>
                      ...
                      <div className="slideTestimonials">
                        ...
                        <div className="leftDataclint">
                          ...
                          <p className="clintFeeds">
                            Groovy Web excels not only in technical skills but also in connecting
                            ...
                            maintaining high-quality standards. I highly recommend Groovy Web.
                      ...
                      <div className="slideTestimonials">
                        ...
                        <div className="leftDataclint">
                          ...
                          <p className="clintFeeds">
                            ...
                            realization. Groovy Web reflected "Trust and Confidence," and the key
                            reason I awarded this project to Groovy Web were that they promote local
                            talents and give them opportunities to outgrow themselves. Groovy Web
                            went above and beyond and constantly supported changes to the initial
                            scope of work. Groovy Web is now our development partner, and I highly
                            recommend them for any custom development requirements.
                          </p>
                          <div className="quotationbottom">
                            <i className="icon-quotation-bottom" />
                          </div>
            ...
            <div className="contactMain">
              <div className="row">
                ...
                <img
                  ...
                  src="frontend/web/groovy-assets/img/assets-img/easter/sectionLineDark.png"
                  alt="sectionLineDark"
                  title="sectionLineDark"
                />
                <img
                  className="ContactLineDark"
                  src="frontend/web/groovy-assets/img/assets-img/easter/sectionLineblue.png"
                  alt="sectionLineDark"
                  title="sectionLineDark"
                />
                <div className="col-md-12">
