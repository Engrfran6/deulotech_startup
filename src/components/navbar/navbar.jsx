...
export const Navbar = () => {
  return (
    <header id="header" className="header fixed-top landing-one ">
      <div className="container-fluid d-flex align-items-center justify-content-between full-header">
        <Link href="//" className="logo d-flex align-items-center">
          ...
          <p className="scoll_downlogo" style={{color:"white", fontSize:"2rem", fontStyle:"italic"}}>DeuloTech</p>
          <p  className="scoll_uplogo">DeuloTech</p>
                  ...
                  <div className="flex-col-menu">
                    ...
                    <div className="TechnologyDiv">
                      ...
                      <div className="flexRowMenu">
                        ...
                        <ul className="dropdown-menu-sub">
                          <li className="subTitle">
                            <Link href="/service/yii2-framework-development">Framework / CMS</Link>
                          </li>
                          <li>
                      ...
                      <div className="flexRowMenu">
                        ...
                        <ul className="dropdown-menu-sub">
                          <li className="subTitle">
                            <Link href="/service/desktop-application-development">Desktop App</Link>
                          </li>
                          <li>
              ...
              <div className="dropdown-menu">
                <div className="flex-col-menu">
                  <div className="servicesDiv whyGroovyMenu">
                    <p className="MegaSubTitle">We Are Groovy</p>
                    <ul className="dropdown-menu-sub">
                      <li>
                  ...
                  <div className="flex-col-menu">
                    ...
                    <div className="SolutionsDiv CompanyDiv">
                      <div className="CompanyDivMenu">
                        ...
                        <div className="comDiv">
                          <p className="MegaSubTitle">Careers@Groovy</p>
                          <div className="flexRowMenu">
                            <ul className="dropdown-menu-sub">
                              <li>
                              ...
                              <li>
                                <Link href="/life-at-groovy">Life@Groovy</Link>
                              </li>
                            </ul>
                          </div>
                        </div>
                        ...
                        <div className="AddDiv">
                          <div className="hireMain">
                            ...
                            <div className="project-explore ReadMore text-left">
                              <button
                                type="button"
                                onclick="if (!window.__cfRLUnblockHandlers) return false; location.to='https://www.groovyweb.co/career';"
                                className="btn custom-btn read-more"
                                data-cf-modified-f399b29743c1a14eb7a2d7f9-="">
                                View more
                              </button>
                            </div>
                          </div>
