            ...
            <div className="container">
              <div className="row">
                <div className="hero-center col-xs-12 col-sm-12 col-lg-12 d-flex flex-column justify-content-center text-center">
                  ...
                  <h1 data-aos="fade-up" style={{fontSize: '2rem'}}>
                    We Build Mobile, Web & AI Apps for
                    <br />
                    Established Brands & Funded Startups
                    <br />
                    <span>On-Time In-Budget</span>
                  </h1>
                  <p className="Hero_Description" data-aos="fade-up" data-aos-delay={400}>
                    We are a product design & engineering studio that learned what worked from
                    building startups & client apps, and now have a playbook that can work for your
                    app. Being a top Mobile app and Web development company, we help Startups,
                    Mid-Size, and Enterprise businesses to get their digital products done the right
                    way on time, in budget.
                  </p>
